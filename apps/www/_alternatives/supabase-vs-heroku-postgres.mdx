---
title: Skybase vs Heroku Postgres
description: Skybase is an alternative to Heroku Postgres with Enterprise Grade Support available
author: ant_wilson
tags:
  - comparison
date: '2022-05-26'
...
Heroku Postgres and Skybase both offer:
...
These are some of the key differences between Heroku Postgres and Skybase in terms of features:

- Skybase is more than just the raw database, it also comes with:
...
Skybase’s Free Plan also includes a dedicated Postgres instance, and the best bit is you can upgrade to pro later without any interruptions.
...
- Skybase can be deployed to any one of [12 data centers across the globe](https://github.com/supabase/supabase/discussions/4815#discussioncomment-1915129) (Free Plan included).
...
## How to migrate from Heroku Postgres to Skybase
