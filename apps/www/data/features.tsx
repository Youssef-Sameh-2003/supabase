...
export type FeatureType = {
   ...
   * - an image
   * - a youtube video
   * - a video sourced from skybase storage
   */
  heroImage: string
  /**
...
export const features: FeatureType[] = [
  // Database
  {
    ...
    description: `
Every Skybase project is a dedicated [Postgres database](https://www.postgresql.org/) - _"a powerful, open source object-relational database system with over 35 years of active development that has earned it a strong reputation for reliability, feature robustness, and performance"_.
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/database/overview',
  ...
  },
  {
    ...
    description: `
Skybase provides an open source toolkit for developing AI applications using Postgres and pgvector. Use the Skybase client libraries to store, index, and query your vector embeddings at scale.
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/ai',
  ...
  },
  {
    ...
    description: `
Skybase automatically generates a comprehensive RESTful API from your database schema, powered by PostgREST. This feature dramatically accelerates development by eliminating the need to write boilerplate server-side code for basic CRUD operations.
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/api#rest-api-overview',
  ...
  },
  {
    ...
    description: `
Skybase offers lightning-fast GraphQL APIs through its custom-built Postgres GraphQL extension, _pg_graphql_.
...
3. Real-time updates: Combine with Skybase's real-time features for live data subscriptions.
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/graphql/api',
  ...
  },
  {
    ...
    description: `
Skybase offers comprehensive database backup solutions to protect your data and ensure business continuity. These include daily backups and Point-in-Time Recovery (PITR), providing robust safeguards against various disaster scenarios.
...
5. Automated process: Backups are managed and monitored by the Skybase team.
...
Skybase's backup solutions provide a balance of security, flexibility, and ease of use, ensuring your data remains protected and recoverable as your project grows.
`,
    icon: DatabaseBackup,
    products: [PRODUCT_SHORTNAMES.DATABASE],
    heroImage: '/images/features/backups.png',
    heroImageLight: '/images/features/backups-light.png',
    docsUrl: 'https://skybase.com/docs/guides/platform/backups',
  ...
  },
  {
    ...
    subtitle: 'White-label the Skybase APIs for a branded experience.',
    description: `
Skybase's custom domain feature allows you to use your own domain for Skybase services, enhancing your application's branding and professionalism. Available as an add-on for paid plans, this feature offers two options: custom domains and vanity subdomains.

## Benefits:
- Branded experience for OAuth consent screens and API endpoints
- Improved portability between Skybase projects
- Consistent domain usage across development, staging, and production

## Custom domains are particularly useful for:
- Applications using Skybase Auth with OAuth
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/platform/custom-domains',
    slug: 'custom-domains',
    status: {
      stage: PRODUCT_STAGES.GA,
  ...
  },
  {
    ...
    description: `
Skybase's Network Restrictions feature allows you to control which IP addresses or ranges can access your database, enhancing your application's security and helping you meet compliance requirements.
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/platform/network-restrictions',
  ...
  },
  {
    ...
    description: `
Skybase's Postgres SSL Enforcement feature allows you to mandate SSL connections to your database, enhancing security by encrypting data in transit and protecting against potential attacks.
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/platform/ssl-enforcement',
  ...
  {
    title: 'Branching',
    subtitle: 'Test and preview changes using Skybase Branches.',
    description: `
Skybase Branching allows you to create and test changes in separate, temporary environments without affecting your production setup. This feature works similarly to Git branches, enabling safe experimentation with configurations, database schemas, and new features.

## Key features
1. Git-based workflow: Integrates with GitHub, creating preview branches for each pull request.
2. Isolated environments: Each branch has its own Skybase instance with separate API credentials.
3. Automatic migrations: Runs new migrations when changes are pushed to the ./skybase/migrations directory.
4. Data seeding: Preview branches can be seeded with sample data using ./skybase/seed.sql.
...
## Skybase Branching is valuable for:
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/platform/branching',
    slug: 'branching',
    status: {
  ...
  },
  {
    ...
    subtitle: 'Manage Skybase infrastructure via Terraform.',
    description: `
The Skybase Terraform provider enables developers and DevOps teams to manage their Skybase infrastructure as code. This integration brings the benefits of Infrastructure as Code (IaC) to your database and backend services, allowing for version-controlled, reproducible, and scalable management of Skybase resources.
...
3. Integration with existing workflows: Seamlessly incorporate Skybase management into your existing Terraform setups.
4. Import capability: Easily import existing Skybase projects into your Terraform state.
...
- Scalability: Effortlessly manage multiple Skybase projects across various teams or clients.
...
`,
  ...
  },
  {
    ...
    description: `
Skybase Read Replicas allow you to deploy additional read-only databases that are kept in sync with your Primary database. This feature enhances performance, improves resource management, and reduces latency for global applications.
...
6. Monitoring tools: Track replication lag and resource utilization through the Skybase Dashboard.
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/platform/read-replicas',
    slug: 'read-replicas',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: false,
  ...
  },
  {
    ...
    description: `
Skybase supports a wide array of Postgres extensions, allowing you to enhance your database with additional functionalities. These extensions enable you to tailor your database to specific needs, from geospatial data to full-text search and advanced analytics.

## Key features
1. Pre-installed extensions: Skybase comes with over 50 pre-configured extensions.
2. Easy management: Enable or disable extensions via the dashboard or SQL commands.
3. Flexible installation: Install custom SQL extensions using Skybase's SQL editor.
...
Popular Postgres extensions supported by Skybase include:
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/database/extensions',
...
4. Easy setup: Create webhooks directly from the Skybase Dashboard or through SQL statements, making integration straightforward.
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/database/webhooks',
  ...
  },
  {
    ...
    description: `
Vault is a Postgres extension and accompanying Skybase UI that simplifies the secure storage of encrypted secrets and other sensitive data in your database. This feature allows developers to utilize Postgres in innovative ways beyond its standard capabilities.
...
2. Easy management: The Skybase dashboard UI makes it simple to store and manage secrets, including environment variables and API keys.
...
`,
    ...
    heroImage: 'https://skybase.com/docs/img/guides/database/vault-hello-compressed.mp4',
    docsUrl: 'https://skybase.com/docs/guides/database/vault',
    slug: 'vault',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
...
5. Easy Integration: New Skybase projects come with a Supavisor connection string by default, simplifying setup for developers.
...
`,
    ...
    docsUrl: 'https://skybase.com/blog/supavisor-postgres-connection-pooler',
    slug: 'supavisor',
    status: {
  ...
  // Realtime
  {
    ...
    description: `
Skybase's Realtime Postgres Changes feature allows you to listen to database changes in real-time using the Realtime system. This capability enables you to build responsive, live-updating applications that reflect database changes instantly.
...
Skybase's Realtime Postgres Changes feature provides a powerful tool for creating responsive, real-time applications while leveraging the full capabilities of your Postgres database.
`,
    icon: DatabaseZap,
    products: [PRODUCT_SHORTNAMES.REALTIME],
    heroImage: 'https://www.youtube-nocookie.com/embed/2rUjcmgZDwQ',
    docsUrl: 'https://skybase.com/docs/guides/realtime/postgres-changes',
  ...
  },
  {
    ...
    description: `
Skybase's Realtime Broadcast feature enables real-time communication between connected clients using the Realtime system. This functionality allows you to build interactive, collaborative applications where users can instantly share messages or data in real-time.
...
Skybase's Realtime Broadcast feature provides a powerful tool for creating responsive, real-time applications with minimal setup and infrastructure management.
`,
    icon: MessageCircle,
    products: [PRODUCT_SHORTNAMES.REALTIME],
    heroImage: 'https://www.youtube-nocookie.com/embed/BelYEMJ2N00',
    docsUrl: 'https://skybase.com/docs/guides/realtime/broadcast',
  ...
  },
  {
    ...
    description: `
Skybase's Realtime Presence feature allows you to track and synchronize shared state between connected users in real-time. This capability enables you to build collaborative applications where users can see each other's status, actions, or any custom state information instantly.
...
Skybase's Realtime Presence feature provides a powerful tool for creating interactive, real-time applications that require shared state management, allowing developers to focus on creating unique and valuable user experiences.
`,
    icon: Users,
    products: [PRODUCT_SHORTNAMES.REALTIME],
    heroImage: 'https://www.youtube-nocookie.com/embed/BelYEMJ2N00',
    docsUrl: 'https://skybase.com/docs/guides/realtime/presence',
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/realtime/authorization#broadcast',
...
This feature is particularly useful for collaborative applications where knowing the online status of team members is crucial while ensuring privacy and security are maintained.`,
    ...
    products: [PRODUCT_SHORTNAMES.REALTIME, PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: 'https://www.youtube-nocookie.com/embed/IXRrU9MpA8Q',
    docsUrl: 'https://skybase.com/docs/guides/realtime/authorization#presence',
  ...
  // Auth
  {
    ...
    description: `
Skybase's Email Login feature enables secure email-based authentication for your applications, allowing users to create accounts and sign in using their email addresses.
...
6. SMTP integration: Use Skybase's email service or configure a custom SMTP server.
...
- Seamless integration: Works with Skybase's other auth providers and features.
...
Skybase's Email Login provides a robust foundation for user authentication, allowing you to focus on building your core application features while ensuring secure account management.
`,
    icon: Mail,
    ...
    docsUrl: 'https://skybase.com/docs/guides/auth/passwords',
    slug: 'email-login',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Skybase's Social Login feature enables users to authenticate using their existing accounts from popular social platforms and services, providing a streamlined, password-free access to your application.
...
Skybase's Social Login feature allows you to improve user experience and potentially increase signup rates while maintaining security and control over user authentication.
`,
    icon: Users,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '/images/features/social-login.png',
    heroImageLight: '/images/features/social-login-light.png',
    docsUrl: 'https://skybase.com/docs/guides/auth/social-login',
    slug: 'social-login',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Skybase's Phone Login feature allows users to authenticate using their phone numbers, providing a password-free login experience with SMS verification.
...
Skybase's Phone Login feature enables a seamless authentication experience, particularly suited for mobile and SMS-centric applications, while providing an additional layer of security through phone number verification.
`,
    icon: Smartphone,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '/images/features/phone-login.png',
    heroImageLight: '/images/features/phone-login-light.png',
    docsUrl: 'https://skybase.com/docs/guides/auth/phone-login',
    slug: 'phone-logins',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Skybase's Passwordless Login via Magic Links allows users to sign in by clicking a unique link sent to their email address, eliminating the need for traditional passwords.
...
Skybase's Magic Links feature offers a secure and user-friendly authentication method, aligning with modern security practices while providing a frictionless login experience.
`,
    icon: Lock,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '',
    docsUrl: 'https://skybase.com/docs/guides/auth/auth-email-passwordless',
  ...
  },
  {
    ...
    description: `
Skybase's Multi-Factor Authentication (MFA) adds an extra layer of security to your application by verifying user identity through additional steps beyond the initial login.
...
Skybase's MFA feature provides a robust tool for enhancing application security, allowing developers to implement strong authentication measures tailored to their specific requirements.
`,
    icon: Lock,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '',
    docsUrl: 'https://skybase.com/docs/guides/auth/auth-mfa',
  ...
  },
  {
    ...
    description: `
Skybase's Row Level Security (RLS) feature allows you to implement granular authorization rules directly in your Postgres database, securing your data at the row level.
...
4. Integration with Skybase Auth: Use built-in helper functions like auth.uid() and auth.jwt() in policies.
...
Skybase's RLS feature provides a powerful tool for implementing sophisticated access control patterns with minimal application code, enhancing security while simplifying development.
`,
    icon: Lock,
    products: [PRODUCT_SHORTNAMES.DATABASE, PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: `https://xguihxuzqibwxjnimxev.skybase.co/storage/v1/object/public/videos/marketing/website/skybase-rls.mp4`,
    docsUrl: 'https://skybase.com/docs/guides/auth/row-level-security',
  ...
  },
  {
    ...
    description: `
Skybase's Captcha Protection feature allows you to integrate CAPTCHA challenges into your authentication flows, providing an additional layer of security against automated attacks and bot activities.

## Key features
1. Multiple provider support: Integration with hCaptcha and Cloudflare Turnstile.
2. Easy configuration: Enable and configure CAPTCHA through the Skybase Dashboard.
...
5. Token-based verification: Use CAPTCHA tokens in Skybase auth functions for enhanced security.
...
Skybase's Captcha Protection feature provides a powerful tool for enhancing application security, helping to protect against various automated threats while maintaining a user-friendly experience.
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/auth/auth-captcha',
  ...
  },
  {
    ...
    description: `
Skybase's Server-side Auth feature provides tools and utilities for implementing secure user authentication in server-side environments, complementing client-side auth implementations.
...
4. @skybase/ssr package: Simplified setup for Skybase client in SSR environments (currently in beta).
...
Skybase's Server-side Auth feature allows developers to create more secure and robust applications with consistent authentication across both client and server components, adhering to security best practices while leveraging Skybase's auth system.
`,
    icon: Server,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '',
    docsUrl: 'https://skybase.com/docs/guides/auth/server-side',
  ...
  {
    title: 'File storage',
    subtitle: 'Skybase Storage makes it simple to store and serve files.',
    description: `
Skybase Storage provides a scalable solution for storing and serving files in your applications, allowing easy management of user-generated content and assets within your Skybase project.
...
## Benefits:
- Seamless integration: Use the same Skybase client for both database and storage operations.
...
Skybase Storage simplifies adding robust file management to your applications, allowing you to focus on building unique features while relying on Skybase for secure, scalable file storage and serving.
`,
    icon: Folders,
    ...
    docsUrl: 'https://skybase.com/docs/guides/storage',
    slug: 'file-storage',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    subtitle: 'Cache large files using the Skybase CDN.',
    description: `
Skybase's Content Delivery Network (CDN) feature caches and serves assets uploaded to Skybase Storage efficiently across the globe, improving latency for users worldwide.
...
Skybase's CDN significantly improves the performance and user experience of your applications, especially for users accessing large files or media content globally, without the complexity of managing your own CDN infrastructure.
`,
    icon: Cloud,
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: '',
    docsUrl: 'https://skybase.com/docs/guides/storage/cdn',
    slug: 'cdn',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Skybase's Smart CDN automatically synchronizes asset metadata to the edge, ensuring content is quickly delivered and remains up-to-date without manual intervention.
...
Skybase's Smart CDN optimizes both performance and content accuracy, providing a superior user experience for applications with dynamic or frequently updated content, without the complexity of manual cache management.
`,
    icon: Cloud,
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: 'https://www.youtube-nocookie.com/embed/NpEl20iuOtg',
    docsUrl: 'https://skybase.com/docs/guides/storage/cdn/smart-cdn',
    slug: 'smart-cdn',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    subtitle: 'Optimize and resize images on-the-fly directly from your Skybase storage buckets.',
    description: `
Skybase’s Image Transformations feature enables developers to dynamically manipulate images stored in Skybase Storage. This functionality is ideal for applications requiring responsive design, efficient media delivery, and streamlined image management.
...
Skybase's Image Transformations feature enables you to efficiently manage and serve optimized images, improving your application's performance and user experience while saving time and resources.

## Integration capabilities

Skybase’s Image Transformations seamlessly integrate within its ecosystem and with external tools:
- Skybase Storage: Directly apply transformations to images stored in Skybase buckets, streamlining media management.
...
## FAQs about image transformations with Skybase

Below are answers to common questions about Skybase Image Transformations.

### What image formats are supported by Skybase Image Transformations?

Skybase Image Transformations primarily support common web-friendly formats such as JPEG, PNG, and WebP. When using the automatic format optimization feature, images can be converted to WebP for supported browsers to enhance performance.
...
Skybase provides a custom loader for Next.js, allowing seamless integration of Image Transformations. By configuring the loader, you can optimize images on-the-fly within your Next.js project.

### Are there any limitations on image size or dimensions?

While Skybase does not impose strict limits on image sizes, it’s recommended to optimize images for web use to ensure faster load times and better performance. Large images may consume more bandwidth and affect loading speeds.
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/storage/image-transformations',
  ...
  },
  {
    ...
    description: `
Skybase's Resumable Uploads feature enables reliable transfer of large files, allowing uploads to be paused and resumed, particularly useful for files exceeding 6MB or in unstable network conditions.
...
Skybase's Resumable Uploads feature significantly improves the reliability and user experience of file uploads, especially for large files or in scenarios with unpredictable network conditions.
`,
    icon: UploadCloud,
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: 'https://www.youtube-nocookie.com/embed/pT2PcZFq_M0',
    docsUrl: 'https://skybase.com/docs/guides/storage/uploads/resumable-uploads',
  ...
  },
  {
    ...
    description: `
Skybase Storage offers compatibility with the S3 protocol, allowing you to use any S3 client to interact with your Storage objects.
...
## Benefits:
- Ecosystem compatibility: Leverage existing S3-compatible tools and libraries with Skybase Storage.
...
- Easy migration: Simplify the process of moving from S3 to Skybase or using both in parallel.
...
Skybase's S3 compatibility allows seamless integration with existing workflows and tools, providing flexibility in data storage and management while benefiting from Skybase's managed solution.
`,
    icon: UploadCloud,
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: '/images/features/s3-compatibility.png',
    heroImageLight: '/images/features/s3-compatibility-light.png',
    docsUrl: 'https://skybase.com/docs/guides/storage/s3/compatibility',
  ...
  // Functions
  {
    ...
    description: `
Skybase's Deno Edge Functions allow you to deploy and run custom TypeScript functions globally at the edge, bringing your code closer to users for enhanced performance and reduced latency.
...
4. Seamless integration: Easy integration with other Skybase services like Auth and Database.
...
- Flexibility: Extend Skybase project capabilities beyond database operations.
...
Skybase's Deno Edge Functions enable you to build responsive, globally distributed applications with custom server-side logic, supporting a wide range of use cases and integrations.
`,
    icon: FileCode2,
    products: [PRODUCT_SHORTNAMES.FUNCTIONS],
    heroImage: 'https://www.youtube-nocookie.com/embed/5OWH9c4u68M',
    docsUrl: 'https://skybase.com/docs/guides/functions',
  ...
  },
  {
    ...
    description: `
Skybase's Regional Invocations feature allows you to execute Edge Functions in a region close to your database, optimizing performance for database-intensive operations. This capability ensures low-latency communication between your functions and database, enhancing overall application responsiveness.
...
By leveraging Skybase's Regional Invocations, you can significantly enhance the performance of your database-centric serverless functions. This feature allows you to build more responsive applications, especially those requiring frequent or complex database interactions, by ensuring that your Edge Functions operate as close as possible to your Skybase database.
`,
    icon: Globe,
    products: [PRODUCT_SHORTNAMES.FUNCTIONS],
    heroImage: '',
    docsUrl: 'https://skybase.com/docs/guides/functions/regional-invocation',
...
3. Code reusability: Easily port existing Node.js code to Skybase Edge Functions.
...
- Projects migrating from Node.js-based serverless platforms to Skybase
...
3. Scalability: Handle AI workloads efficiently with Skybase's managed infrastructure.
4. Cost-effective AI deployment: Leverage powerful AI models without significant upfront investments.
5. Real-time AI processing: Combine AI capabilities with Skybase's real-time features for dynamic applications.
6. Data synergy: Seamlessly use your Skybase data with AI models for personalized experiences.
...
`,
  ...
  // Platform
  {
    ...
    description: `
Skybase's Command Line Interface (CLI) tool provides developers with a powerful and flexible way to manage their Skybase projects directly from the terminal. This feature streamlines the development workflow, allowing for local development, testing, and seamless deployment of Skybase projects.

## Key benefits
1. Local development: Set up and run a local Skybase instance for development and testing.
2. Version control integration: Easily manage database migrations and schema changes with Git-like workflows.
3. Automated deployments: Deploy changes to your Skybase project with simple CLI commands.
...
7. CI/CD integration: Incorporate Skybase operations into your continuous integration and deployment pipelines.

## The CLI is particularly valuable for:
- Development teams working on Skybase projects collaboratively
- DevOps professionals managing Skybase deployments across multiple environments
- Open-source projects requiring reproducible Skybase setups
...
- Any application needing a streamlined local-to-production workflow with Skybase

By leveraging the Skybase CLI, you can significantly improve your development workflow, ensuring consistency between local and production environments, streamlining deployments, and making it easier to manage complex Skybase projects. This tool empowers developers to work more efficiently with Skybase, whether they're building small prototypes or large-scale applications.
`,
    icon: Terminal,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: 'https://www.youtube-nocookie.com/embed/vyHyYpvjaks',
    docsUrl:
      'https://skybase.com/docs/guides/local-development?queryGroups=package-manager&package-manager=pnpm',
    slug: 'cli',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Skybase's Management API provides a powerful interface for programmatically managing your Skybase projects. This feature allows developers and DevOps teams to automate project creation, configuration, and maintenance tasks, enabling more efficient and scalable project management workflows.

## Key benefits
1. Automation: Automate repetitive tasks like project creation and configuration.
2. Scalability: Easily manage multiple Skybase projects across different environments.
3. CI/CD integration: Incorporate Skybase project management into your continuous integration and deployment pipelines.
...
- Large organizations managing multiple Skybase projects
- SaaS platforms offering Skybase-powered backends to their customers
- DevOps teams implementing infrastructure-as-code practices
- Managed service providers offering Skybase as part of their stack
...
By utilizing the Skybase Management API, you can create more efficient, scalable, and automated workflows for managing your Skybase projects. This feature is especially powerful for organizations dealing with multiple projects or environments, enabling them to maintain consistency, reduce manual errors, and quickly respond to changing project requirements.
`,
    icon: FileCode2,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '/images/features/management-api.png',
    heroImageLight: '/images/features/management-api-light.png',
    docsUrl: 'https://skybase.com/docs/reference/api/introduction',
    slug: 'management-api',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
...
`,
    ...
    docsUrl:
      'https://skybase.com/docs/guides/database/postgres/custom-claims-and-role-based-access-control-rbac',
  ...
  // Analytics
  {
    ...
    description: `
Skybase Reports provide comprehensive insights into your project's performance, usage patterns, and overall health. This feature offers a detailed view of various metrics, helping you optimize your application, troubleshoot issues, and make data-driven decisions about resource allocation and scaling.
...
By leveraging Skybase Reports, you gain a understanding of your project's performance and usage patterns. This feature empowers you to make informed decisions about scaling, optimization, and resource allocation, ensuring that your application runs efficiently and cost-effectively. Whether you're troubleshooting issues, planning for growth, or optimizing costs, Skybase Reports provides the insights you need to manage your project effectively.
`,
    icon: BarChart,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '/images/features/reports-and-metrics.png',
    heroImageLight: '/images/features/reports-and-metrics-light.png',
    docsUrl: 'https://skybase.com/blog/skybase-reports-and-metrics',
  ...
  },
  {
    ...
    description: `
Skybase's SOC 2 Compliance demonstrates its commitment to maintaining the highest standards of security, availability, and confidentiality. This certification assures users that Skybase follows strict information security policies and procedures, encompassing the security, availability, processing, integrity, and confidentiality of customer data.
...
4. Standardized processes: Benefit from Skybase's adherence to industry-standard security practices.
5. Continuous improvement: Skybase's commitment to maintaining SOC 2 compliance ensures ongoing security enhancements.
6. Transparency: Access to SOC 2 reports provides insight into Skybase's security controls.
7. Competitive advantage: Use Skybase's compliance as a selling point for your own services.
...
Leveraging Skybase's SOC 2 Compliance involves:
1. Reviewing Skybase's SOC 2 report to understand its security practices
2. Aligning your application's security practices with Skybase's standards
3. Utilizing Skybase's compliant features to enhance your own security posture
4. Communicating the benefits of building on a SOC 2 compliant platform to stakeholders

By building on Skybase's SOC 2 compliant platform, you gain a significant advantage in terms of security and trust. This compliance demonstrates to your users, partners, and regulators that you take data protection seriously and have chosen a backend platform that adheres to rigorous security standards. Whether you're a startup looking to win enterprise clients or an established company aiming to enhance your security posture, Skybase's SOC 2 compliance provides a solid foundation for building secure, trustworthy applications.
`,
    icon: ShieldCheck,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://skybase.com/docs/guides/security/soc-2-compliance',
  ...
  // Studio
  {
    title: 'Skybase AI Assistant',
    subtitle: 'Your intelligent companion for managing Postgres databases.',
    description: `
Skybase AI Assistant is integrated into the Skybase Dashboard to drastically improve your database management experience. This tool helps streamline your workflow, significantly reducing the time it takes to transition from concept to product.
...
With Skybase AI Assistant, you gain a powerful ally in your development process, helping you work more efficiently and effectively while keeping you focused on your goals.
`,
    icon: Brain,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: 'https://www.youtube-nocookie.com/embed/_fdP-aaTHgw',
    docsUrl: '/blog/skybase-ai-assistant-v2',
    slug: 'ai-assistant',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
The Logs & Analytics feature in Skybase provides users with comprehensive logging and analytics capabilities, powered by Logflare. This tool enables developers to track and analyze log events from various Skybase services, such as the API gateway, Postgres databases, Storage, Edge Functions, and more. By leveraging a multi-node Elixir cluster, Skybase processes billions of log events daily, ensuring that users have access to critical insights for optimizing their applications.
...
4. Customizable Dashboards: Create tailored views within Skybase Studio to visualize log data and track key performance indicators (KPIs).
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/monitoring-troubleshooting/logs',
    slug: 'logs-analytics',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
The Visual Schema Designer is an integral part of [Skybase Studio](/features?products=studio), offering users a seamless way to create and modify PostgreSQL database schemas without writing SQL code. This visual database design tool simplifies the process of structuring your database by allowing you to:
...
## Integration capabilities with Skybase’s Schema designer

The Visual Schema Designer seamlessly integrates within the Skybase ecosystem, enhancing your database management experience:

- Skybase Studio integration. Embedded directly into Skybase Studio, the Visual Schema Designer allows for intuitive schema creation and modification alongside other powerful tools like the SQL Editor and Role Management UI. 
...
### Can I use this with self-hosted Skybase instances?

Yes, our drag-and-drop schema builder is available for both cloud and self-hosted Skybase setups.
...
`,
    ...
    docsUrl: 'https://skybase.com/blog/skybase-studio-3-0#schema-visualizer',
  ...
  },
  {
    ...
    description: `
Policy Templates provide a library of predefined security policies that can be easily applied to your Skybase projects. This feature streamlines the process of establishing role-based access control and other security measures, ensuring that best practices are followed consistently across applications.
...
4. User-Friendly: Simplifies policy application through an intuitive interface within the Skybase Studio.
...
`,
  ...
  },
  {
    ...
    description: `
The SQL Editor in [Skybase Studio](/features?products=studio) provides users with a robust platform for writing, executing, and managing SQL queries directly within their browser. This feature is designed to enhance productivity by offering syntax highlighting, auto-completion, and error detection, making it easier for developers to interact with their databases efficiently.
...
Integrated directly into the SQL Editor, Skybase AI serves as an intelligent assistant to enhance your database development workflow.
...
## Seamless integration with Skybase ecosystem

The SQL Editor is deeply integrated within the Skybase platform, offering a cohesive development experience.
...
- Wrappers UI: Easily connect and query external data sources like S3, ClickHouse, and BigQuery within your Skybase projects.
...
Below are answers to common questions about the Skybase SQL Editor.

### Can I use the SQL Editor with self-hosted Skybase projects?

Yes, the SQL Editor is available for self-hosted Skybase instances. However, certain features like Shared SQL Snippets may not be fully supported in self-hosted environments.

### How does Skybase AI assistance work in the SQL Editor?

Skybase AI is integrated directly into the SQL Editor, providing real-time assistance for writing and optimizing SQL queries. It can transform natural language prompts into SQL code, offer context-aware suggestions, and help debug errors. This feature enhances productivity and lowers the barrier to effective database management.

### Is there a way to share my SQL queries with team members?

Skybase offers a Shared SQL Snippets feature that allows you to share and manage SQL code snippets collaboratively within your team. This facilitates better collaboration and code reuse among team members.
...
### Is the editor accessible via the Skybase CLI?

While the editor is primarily a web-based tool within Skybase Studio, you can execute SQL queries using the [Skybase CLI](/features/cli) by utilizing the skybase db query command. This allows for integration into scripts and automation workflows.
`,
    icon: FileCode2,
    products: [ADDITIONAL_PRODUCTS.STUDIO],
...
3. User-friendly dashboard: Presents findings in an easily digestible format within Skybase Studio.
...
`,
    ...
    docsUrl: 'https://skybase.com/blog/security-performance-advisor',
...
5. Predefined Roles: Skybase extends Postgres with a set of predefined roles, simplifying the initial setup for new projects.
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/database/postgres/roles',
    slug: 'postgres-roles',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
User Impersonation in Skybase allows developers to simulate the experience of any user within their application. This feature is particularly useful for testing and debugging, as it enables you to view and interact with your application exactly as a specific user would.

## Key benefits
1. Realistic testing: Validate user-specific features and permissions by impersonating users directly in Skybase Studio.
...
`,
    ...
    products: [ADDITIONAL_PRODUCTS.STUDIO],
    heroImage:
      'https://xguihxuzqibwxjnimxev.skybase.co/storage/v1/object/public/videos/docs/fk-lookup.mp4',
    docsUrl: 'https://skybase.com/blog/skybase-studio-2.0#foreign-key-selector',
  ...
  },
  {
    ...
    description: `
Log Drains enable developers to export logs generated by Skybase products—such as the Database, Storage, Realtime, and Auth—to external destinations like Datadog or custom HTTP endpoints. This feature provides a unified view of logs within existing logging and monitoring systems, allowing teams to build robust alerting and observability pipelines.

## Key benefits
1. Centralized logging: Consolidate logs from multiple Skybase services into a single location for easier management and analysis.
...
`,
    ...
    docsUrl: 'https://skybase.com/blog/log-drains',
    slug: 'log-drains',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    subtitle: 'Easily integrate Skybase with your JavaScript applications.',
    description: `
The Skybase JavaScript Client Library provides a straightforward way to interact with your Skybase database and services directly from your JavaScript applications. This library simplifies the process of making API calls, managing authentication, and handling real-time updates, making it an essential tool for developers working with Skybase.

Key benefits:
1. Simplified API interaction: Easily connect to your Skybase backend with minimal setup.
...
This feature is particularly valuable for developers looking to build dynamic web applications that leverage the power of Skybase as a backend service.
`,
    icon: JsIcon,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://skybase.com/docs/reference/javascript/start',
  ...
  },
  {
    ...
    subtitle: 'Integrate Skybase into your Flutter applications effortlessly.',
    description: `
The Skybase Flutter Client Library allows developers to easily integrate Skybase into their Flutter applications. This library provides a comprehensive set of tools for managing database interactions, user authentication, and real-time data updates, all tailored for the Flutter framework.

Key benefits:
1. Seamless integration: Connect your Flutter app to Skybase with minimal configuration.
...
5. Active community: Engage with other Flutter developers leveraging Skybase for their projects.
...
`,
    ...
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://skybase.com/docs/reference/dart/start',
  ...
  },
  {
    ...
    subtitle: 'Effortlessly connect your Swift applications to Skybase.',
    description: `
The Skybase Swift Client Library provides an easy way for developers to integrate their iOS applications with Skybase services. This library simplifies database access, user authentication, and real-time data handling, making it an essential tool for Swift developers.

Key benefits:
1. Easy integration: Quickly connect your Swift app to Skybase with straightforward setup instructions.
...
5. Supportive community: Join a community of Swift developers using Skybase for their app development needs.

This feature is particularly valuable for iOS developers looking to leverage the capabilities of Skybase in their mobile applications.
`,
    icon: SwiftIcon,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://skybase.com/docs/reference/swift/start',
  ...
  },
  {
    ...
    subtitle: 'Integrate Skybase easily into your Python applications.',
    description: `
The Skybase Python Client Library enables developers to connect their Python applications with Skybase effortlessly. This library provides tools for interacting with the database, managing user authentication, and handling real-time updates, tailored specifically for Python developers.

Key benefits:
1. Simple connection setup: Easily connect your Python application to Skybase with minimal configuration.
...
5. Engaged community support: Connect with other Python developers utilizing Skybase in their projects.

This feature is especially beneficial for Python developers looking to build robust applications powered by a scalable backend service like Skybase.
`,
    icon: PythonIcon,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://skybase.com/docs/reference/python/start',
  ...
  },
  {
    ...
    description: `
Skybase Cron is a Postgres module designed to schedule recurring Jobs with cron syntax directly within your database. Seamlessly integrated into the Skybase ecosystem, it allows users to automate tasks like executing SQL snippets, calling Database Functions, triggering Skybase Edge Functions, or syncing with external systems via webhooks.
...
2. Skybase integration: Integrates seamlessly with the rest of the Skybase platform, including Skybase Edge Functions and Database Webhooks.
...
6. Enhanced observability: Monitor job history, debug errors, and review logs directly from the Skybase Dashboard.
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/cron',
    slug: 'skybase-cron',
    status: {
      stage: PRODUCT_STAGES.BETA,
      availableOnSelfHosted: true,
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/database/orioledb',
    slug: 'orioledb',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Skybase Queues is a native Postgres-based message queue system built on the PGMQ extension, offering developers a seamless way to persist and guarantee delivery of messages, which improves the scalability and resiliency of horizontally deployed services.

Skybase Queues provides the reliability of Postgres with the simplicity of Skybase's developer experience, enabling teams to manage queues without maintaining additional infrastructure.
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/queues',
    slug: 'queues',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
  ...
  },
  {
    title: 'MCP Server',
    subtitle:
      'Connect your AI tools using the official Skybase Model Context Protocol (MCP) server.',
    description: `
The MCP Server bridges the gap between AI tools and your Skybase projects, enabling natural language commands and agent-like experiences for database management. It standardizes how Large Language Models (LLMs) communicate with platforms like Skybase, allowing AI tools such as Cursor, Claude, and Windsurf to spin up projects, design tables, query data, and manage configurations—all through a unified protocol.

With the MCP Server, you can:

- Create and manage Skybase projects directly from your AI tool.
...
The MCP Server simplifies the integration of AI tools with Skybase, enabling a seamless development experience without the need for custom APIs or wrappers.

## Key benefits
1. AI-native development: Let AI tools like Cursor or Claude manage your Skybase projects with natural language commands.
2. Standardized tool ecosystem: MCP standardizes how tools interact with Skybase, enabling a plug-and-play experience for AI-powered workflows.
...
- Frontend developers. Use tools like Cursor to scaffold Next.js apps backed by Skybase, configure environment files, and manage schema without leaving the IDE.
- Backend engineers. Automate tasks like table creation, migrations, and TypeScript generation directly from AI tools.
- AI engineers. Build custom AI agents that interact with Skybase databases, enabling dynamic and responsive AI-powered applications.
- Educators & learners. Explore modern AI development practices by combining LLMs and databases in real-world projects.

## Integration capabilities with Skybase MCP Server

The MCP Server integrates seamlessly with popular AI tools and the broader Skybase ecosystem:

- Cursor. Connect your IDE directly to Skybase for AI-driven development workflows.
- Claude. Use Claude desktop and code tools to interact with Skybase resources and services.
- Windsurf (Codium). Configure the MCP Server to manage Skybase projects directly within Codium's AI assistant.
- Visual Studio Code (Copilot). Leverage AI capabilities to query data, generate types, and manage projects within VS Code.
- Cline (VS Code extension). Connect Cline to Skybase through the MCP Server for AI-assisted database operations.
...
MCP is a standard that defines how AI tools and platforms communicate. It enables AI tools to interact with Skybase by calling functions, retrieving data, and executing tasks through a common protocol.

### Do I need a personal access token (PAT) to use the MCP Server?

Yes, you'll need to create a PAT in your Skybase settings to authenticate the MCP Server. Future versions of MCP will support OAuth login flows for simpler authentication.

### Can I use the MCP Server with self-hosted Skybase instances?

No, the official Skybase MCP Server connects directly to Skybase Cloud. For local instances, you can use the Postgres MCP Server instead.
...
`,
    ...
    docsUrl: 'https://skybase.com/docs/guides/getting-started/mcp',
    slug: 'mcp-server',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
...
## Integration capabilities with Skybase

Declarative schemas integrate directly with the Skybase CLI, allowing you to:

- Define your schema in SQL files within the \`skybase/schemas\` directory.
- Use \`skybase db diff\` to generate migration files based on schema changes.
- Apply and deploy migrations using the Skybase CLI, ensuring consistency across local and remote environments.
...
No. Skybase provides a schema diff tool (\`skybase db diff\`) that automatically generates migration files from your declarative schema files.

### Can I use declarative schemas with my existing projects?

Yes. You can pull your production schema into declarative files by running \`skybase db dump > skybase/schemas/prod.sql\`. From there, you can split the schema into smaller files and adopt a declarative workflow.
...
For detailed instructions and best practices, see the [Declarative Schemas documentation](https://skybase.com/docs/guides/database/declarative-schemas).
`,
    icon: Database,
    products: [PRODUCT_SHORTNAMES.DATABASE],
    heroImage: 'https://www.youtube-nocookie.com/embed/EALkUlOKvAs',
    docsUrl: 'https://skybase.com/docs/guides/local-development/declarative-database-schemas',
