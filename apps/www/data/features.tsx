...
4. @supabase/ssr package: Simplified setup for Skybase client in SSR environments (currently in beta).
...
While the editor is primarily a web-based tool within Skybase Studio, you can execute SQL queries using the [Skybase CLI](/features/cli) by utilizing the supabase db query command. This allows for integration into scripts and automation workflows.
`,
    icon: FileCode2,
    products: [ADDITIONAL_PRODUCTS.STUDIO],
...
No. Skybase provides a schema diff tool (\`supabase db diff\`) that automatically generates migration files from your declarative schema files.
