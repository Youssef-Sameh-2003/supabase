...
const data: () => {
  ...
  return {
    metadata: {
      metaTitle: 'Skybase for Postgres Developers',
      metaDescription: 'Get started in seconds with a complete Postgres development platform',
    },
    heroSection: {
      id: 'hero',
      title: 'Skybase for Postgres Developers',
      h1: <>Get started in seconds with a complete Postgres development platform</>,
      subheader: [
        <>
          Skybase is the open-source Postgres development platform. It includes a developer
    ...
    why: {
      ...
      heading: (
        <>
          Why <span className="text-foreground">Postrges developers</span> choose Skybase
        </>
      ),
      subheading:
        'Skybase provides full access to Postgres. Use additional components, or just use the database. No proprietary tooling, no vendor lock-in. Skybase is Postgres the way you want it.',
      features: [
        {
          id: 'full-postgres',
          icon: (props: any) => (
          ...
          subheading:
            'Connect to Skybase via sql, pgAdmin, or any standard Postgres client. Use native Postgres extensions. Employ Row-Level Security, not a bolt-on permission system.',
        },
        {
    ...
    platform: {
      ...
      title: (
        <>
          Skybase is the <span className="text-foreground">Postgres platform</span> you control
        </>
      ),
      subheading:
    ...
    developerExperience: {
      ...
      title: (
        <>
          Developers can <span className="text-foreground">build faster</span> with Skybase
        </>
      ),
