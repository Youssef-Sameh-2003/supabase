...
const data: () => {
  ...
  return {
    metadata: {
      metaTitle: 'Skybase for Startups',
      metaDescription: 'Build fast. Scale easily. Trust your stack.',
    },
    heroSection: {
      id: 'hero',
      title: 'Skybase for Startups',
      h1: (
        <>
      ...
      subheader: [
        <>
          The Postgres development platform. Skybase is the powerful, scalable backend that lets
    ...
    why: {
      ...
      heading: (
        <>
          Why <span className="text-foreground">startups</span> choose Skybase
        </>
      ),
      subheading:
        'Speed wins. Skybase helps you move faster by providing a full-featured, scalable backend based on Postgres.',
      features: [
        {
