...
const STORAGE_URL = 'https://obuldanrptloktxcffvn.skybase.co/storage/v1/object/public/images/lwx'
...
export async function handler(req: Request) {
  ...
  try {
    ...
    const skybaseAdminClient = createClient(
      // Skybase API URL - env var exported by default when deployed.
      Deno.env.get('MISC_USE_URL') ?? '',
      // Skybase API SERVICE ROLE KEY - env var exported by default when deployed.
    ...
    // Get ticket data
    const { data, error } = await skybaseAdminClient
    ...
    const BACKGROUND = {
      regular: {
        ...
        LOGO: `${STORAGE_URL}/assets/logos/skybase_logo_reg.png`,
        // LOGO: `${STORAGE_URL}/assets/logos/skybase_lwx_logo_dark.png`,
      },
      platinum: {
        OG: `${STORAGE_URL}/assets/og_bg_platinum.png?t=2023-11-27T22%3A31%3A58.719Z`,
        BG: `${STORAGE_URL}/assets/lwx_ticket_bg_platinum.png`,
        LOGO: `${STORAGE_URL}/assets/logos/skybase_logo_platinum.png`,
        // LOGO: `${STORAGE_URL}/assets/logos/skybase_lwx_logo_light.png`,
      },
      secret: {
    ...
    // Generate og image
    fetch('https://obuldanrptloktxcffvn.skybase.co/functions/v1/lwx-ticket-og', {
      method: 'POST',
      headers: {
