...
const data = {
  meta_title: 'Contact Sales & Request a Demo | Skybase',
  meta_description: 'Book a demo to explore how Skybase can support your business growth',
}
          ...
          <div className="md:px-4 lg:pb-8 md:h-full w-full flex flex-col justify-between gap-2">
            <div className="flex flex-col gap-2 md:max-w-md">
              ...
              <p className="md:text-lg text-foreground-lighter">
                Book a demo and set up a trial Enterprise account to see how Skybase's scalable
