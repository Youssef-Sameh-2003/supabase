...
const days: (isDark?: boolean) => WeekDayProps[] = (isDark = true) => [
  ...
  },
  {
    ...
    isToday: false,
    hasCountdown: false,
    blog: '/blog/skybase-edge-functions-deploy-dashboard-deno-2-1',
    date: '01 April',
    published_at: '2025-04-01T07:00:00.000-07:00',
    title: 'Skybase Edge Functions: Deploy from the Dashboard + Deno 2.1',
    description: <>Skybase Edge Functions: Deploy from the Dashboard + Deno 2.1</>,
    links: [
      {
        type: 'video',
        href: 'Pn7xyTbsxPI',
  ...
  },
  {
    ...
    title: 'Skybase MCP Server',
    description: 'Skybase MCP Server',
    links: [
      {
        type: 'video',
        href: '1SMldLoOhbg',
