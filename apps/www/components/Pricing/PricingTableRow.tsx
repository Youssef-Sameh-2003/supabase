...
export const pricingTooltips: PricingTooltips = {
  ...
  'database.advancedDiskConfig': {
    main: 'Skybase databases are backed by high performance SSD disks. The disk can be scaled up to 60 TB, 80,000 IOPS and 4,000 MB/s throughput.',
  },
  ...
  'security.accessRoles': {
    main: (
      <span className="prose text-xs">
        Skybase provides granular access controls to manage permissions across your organizations
