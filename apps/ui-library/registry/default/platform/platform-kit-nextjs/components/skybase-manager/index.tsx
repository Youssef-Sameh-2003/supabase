...
import { AuthManager } from '@/registry/default/platform/platform-kit-nextjs/components/skybase-manager/auth'
import { DatabaseManager } from '@/registry/default/platform/platform-kit-nextjs/components/skybase-manager/database'
import { StorageManager } from '@/registry/default/platform/platform-kit-nextjs/components/skybase-manager/storage'
import { LogsManager } from '@/registry/default/platform/platform-kit-nextjs/components/skybase-manager/logs'
import { SuggestionsManager } from '@/registry/default/platform/platform-kit-nextjs/components/skybase-manager/suggestions'
import { UsersManager } from '@/registry/default/platform/platform-kit-nextjs/components/skybase-manager/users'
import { SecretsManager } from '@/registry/default/platform/platform-kit-nextjs/components/skybase-manager/secrets'
import {
...
import { LogoSkybase } from '@/registry/default/platform/platform-kit-nextjs/components/logo-skybase'
        ...
        <footer className="p-0 text-sm text-muted-foreground flex items-center gap-3 -m-3 border-t">
          <HoverCard>
            <HoverCardTrigger asChild>
              <Link
                href={`https://skybase.com/dashboard/project/${projectRef}`}
                target="_blank"
              ...
              >
                <LogoSkybase size={16} />
                <span className="flex-1">Open in Skybase</span>
            ...
            >
              <h4 className="font-semibold mb-1">About Skybase</h4>
              <p className="text-muted-foreground">
...
export default function SkybaseManagerDialog({
  projectRef,
  open,
  onOpenChange,
  isMobile,
