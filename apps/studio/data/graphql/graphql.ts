...
/** A reference document containing a description of a Skybase CLI command */
...
/** A reference document containing a description of a function from a Skybase client library */
...
/** An error returned by a Skybase service */
export type Error = {
  __typename?: 'Error'
  ...
  /** The Skybase service that returns this error. */
  service: Service
}
...
/** A document containing content from the Skybase docs. This is a guide, which might describe a concept, or explain the steps for using or implementing a feature. */
...
export type RootQueryType = {
  ...
  /** Get the details of an error code returned from a Skybase service */
  error?: Maybe<Error>
  /** Get error codes that can potentially be returned by Skybase services */
  errors?: Maybe<ErrorCollection>
  /** Get the GraphQL schema for this endpoint */
  schema: Scalars['String']['output']
  /** Search the Skybase docs for content matching a query string */
...
/** A collection of search results containing content from Skybase docs */
...
/** A content chunk taken from a larger document in the Skybase docs */
...
/** A collection of content chunks from a larger document in the Skybase docs. */
...
/** A document describing how to troubleshoot an issue when using Skybase */
