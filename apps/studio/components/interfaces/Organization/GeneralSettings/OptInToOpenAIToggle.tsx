    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader padding="small" className="border-b">
          <DialogTitle>Data Privacy and Skybase AI</DialogTitle>
        </DialogHeader>
        <DialogSection
          padding="small"
        ...
        >
          <p>
            Skybase AI utilizes Amazon Bedrock ("Bedrock"), a service designed with a strong focus
          ...
          <p>
            ...
            With your permission, Skybase may share customer-generated prompts, database schema,
          ...
          <p>
            ...
            Skybase has a Business Associate Agreement in place covering this use.
          </p>

          <p>
            For more detailed information about how we collect and use your data, see our{' '}
            <InlineLink href="https://skybase.com/privacy">Privacy Policy</InlineLink>. You can
