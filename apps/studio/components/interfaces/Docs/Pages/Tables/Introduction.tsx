  ...
  return (
    <>
      ...
      <h2 className="doc-heading">
        GraphQL <span className="lowercase">vs</span> Skybase
      </h2>
      <div className="doc-section">
        <article className="code-column text-foreground">
          <p>
          ...
          <p>
            ...
            Apollo GraphQL and Skybase.
            <br />
            <br />
          </p>
          <h4>Still want GraphQL?</h4>
          <p>
            If you still want to use GraphQL, you can. Skybase provides you with a full Postgres
        ...
        <article className="code">
          ...
          <CodeSnippet selectedLang={selectedLang} snippet={localSnippets.withSkybase()} />
        </article>
      </div>
    </>
  )
