    ...
    <>
      ...
      <div className="doc-section">
        <article className="code-column text-foreground">
          ...
          <p>
            You can initialize a new Skybase client using the <code>createClient()</code> method.
            The Skybase client is your entrypoint to the rest of the Skybase functionality and is
            the easiest way to interact with everything we offer within the Skybase ecosystem.
          </p>
        </article>
