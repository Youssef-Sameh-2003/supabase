  ...
  return (
    <ConnectTabs>
      <ConnectTabTriggers>
        ...
        <ConnectTabTrigger value="src/utility/skybaseClient.ts" />
      ...
      <ConnectTabContent value="src/utility/skybaseClient.ts">
...
export const skybaseClient = createClient(SUPABASE_URL, SUPABASE_KEY, {
  db: {
    schema: "public",
  },
  auth: {
