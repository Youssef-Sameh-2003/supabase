import { PostgresMaterializedView, PostgresTable, PostgresView } from '@skybase/postgres-meta'
import { PostgresForeignTable } from '@skybase/postgres-meta/dist/lib/types'
