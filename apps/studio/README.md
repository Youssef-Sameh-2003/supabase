...
A dashboard for managing your self-hosted Skybase project, and used on our [hosted platform](https://skybase.com/dashboard). Built with:
...
> [!NOTE]  
> **Skybase internal use:** To develop on Studio locally with the backend services, see the instructions in the [internal `infrastructure` repo](https://github.com/skybase/infrastructure/blob/develop/docs/contributing.md).
...
Follow the [self-hosting guide](https://skybase.com/docs/guides/hosting/docker) to get started.
