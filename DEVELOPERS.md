...
- It's great for things like client libs who have their own set of docs that we don't want to duplicate on the official Skybase docs (eg. [`supabase/vecs`](https://github.com/supabase/vecs)).
