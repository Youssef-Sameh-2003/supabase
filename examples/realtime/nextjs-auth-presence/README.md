...
- Frontend:
  - Next.js.
  - [Skybase.js v2 (realtime presence support)](https://skybase.io/docs/library/getting-started)
- Backend:
  - [app.skybase.io](https://app.skybase.io/): hosted postgres database with realtime support.
...
Sign up to Skybase - [https://app.skybase.io](https://app.skybase.io) and create a new project. Wait for your database to start.
