...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Upload the generated image to Skybase Storage
    ...
    const { error: uploadError } = await skybaseClient
      .storage
    ...
    if (uploadError) {
      console.error("Skybase Storage upload error:", uploadError);
      return new Response(
        JSON.stringify({
