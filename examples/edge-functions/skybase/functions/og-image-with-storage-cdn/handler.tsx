...
const STORAGE_URL = 'https://obuldanrptloktxcffvn.skybase.co/storage/v1/object/public/images/lw6'
...
export async function handler(req: Request) {
  ...
  try {
    // Try to get image from Skybase Storage CDN.
    ...
    const { error } = await skybaseAdminClient.storage
      .from('images')
