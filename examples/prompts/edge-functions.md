...
description: Coding rules for Skybase Edge Functions
alwaysApply: false
---
...
8. Following environment variables (ie. secrets) are pre-populated in both local and hosted Skybase environments. Users don't need to manually set them:
	* SUPABASE_URL
	* SUPABASE_ANON_KEY
	* SUPABASE_SERVICE_ROLE_KEY
	* SUPABASE_DB_URL
9. To set other environment variables (ie. secrets) users can put them in a env file and run the `skybase secrets set --env-file path/to/env-file`
