...
import { createClient } from "npm:@skybase/skybase-js";
...
Deno.serve(async (req) => {
  ...
  if (response.$metadata.httpStatusCode === 200) {
    ...
    const { data: upload, error: uploadError } = await skybaseClient.storage
      .from("images")
...
/* To invoke locally:
  ...
  2. Start with env: `skybase functions serve --env-file skybase/.env`
