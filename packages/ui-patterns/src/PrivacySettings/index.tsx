              ...
              <Admonition
                ...
                description={
                  <>
                    ...
                    <Link href="https://skybase.com/dashboard/support/new" className="underline">
                      contact support
                    </Link>
                    .
                  </>
      ...
      <Toggle
        ...
        descriptionText={
          <>
            ...
            <br />
            <Link
              href="https://skybase.com/privacy#8-cookies-and-similar-technologies-used-on-our-european-services"
              className="underline"
            >
              Learn more
            </Link>
