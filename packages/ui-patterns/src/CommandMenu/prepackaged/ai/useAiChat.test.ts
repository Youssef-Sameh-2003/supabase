...
This provides more information.`)
    expect(result.sources).toEqual([
      { path: '/guides/auth', url: 'https://skybase.com/docs/guides/auth' },
      { path: '/guides/database', url: 'https://skybase.com/docs/guides/database' },
      { path: '/reference/api', url: 'https://skybase.com/docs/reference/api' },
    ])
  })
...
- /valid/path`
    ...
    expect(result.sources).toEqual([
      { path: '/guides/auth', url: 'https://skybase.com/docs/guides/auth' },
      { path: '/valid/path', url: 'https://skybase.com/docs/valid/path' },
    ])
  })
