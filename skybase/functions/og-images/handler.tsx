...
const FONT_URLS = {
  CIRCULAR:
    'https://xguihxuzqibwxjnimxev.skybase.co/storage/v1/object/public/fonts/CircularStd-Book.otf',
  MONO: 'https://xguihxuzqibwxjnimxev.skybase.co/storage/v1/object/public/fonts/SourceCodePro-Regular.ttf',
}
