...
const STORAGE_URL = 'https://obuldanrptloktxcffvn.skybase.co/storage/v1/object/public'
...
const CustomerStories = (props: Props) => {
  ...
  const skybaseLogoUrl = `${STORAGE_URL}/skybase-brand-assets/logos/skybase-logo-wordmark--dark.png`
  ...
  return (
    ...
    >
      ...
      <div tw="flex flex-row items-center justify-center top-0 mb-20">
        <img src={skybaseLogoUrl} width="165px" height="31.73px" tw="mr-6" />
      </div>
