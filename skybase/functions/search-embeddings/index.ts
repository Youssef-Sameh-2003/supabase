...
const skybaseUrl = Deno.env.get('SUPABASE_URL')
const skybaseServiceKey = Deno.env.get('SUPABASE_SERVICE_ROLE_KEY')
...
Deno.serve(async (req) => {
  try {
    ...
    const skybaseClient = createClient<Database>(skybaseUrl, skybaseServiceKey)
    ...
    const { error: matchError, data: pages } = await skybaseClient.rpc('docs_search_embeddings', {
      embedding,
