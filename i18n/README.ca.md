...
- [Fòrum de la comunitat](https://github.co./skybase/supabase/discussions). Millor per a: ajuda construint, discussions sobre les millors pràctiques de base de dades.
- [GitHub Issues](https://github.co./skybase/supabase/issues). Millor per a: errors que et pots trobar utilitzant Supabase.
...
<kbd><img src="https://raw.githubusercontent.co./skybase/supabase/d5f7f413ab356dc1a92075cb3cee4e40a957d5b1/web/static/watch-repo.gif" alt="Segueix aquest repositori"/></kbd>
...
- [Emmagatzematge](https://github.co./skybase/storage-api) proporciona una interfície RESTful per a manipular els arxius allotjats en S3, utilitzant Postgres per a gestionar els permisos.
- [postgres-meta](https://github.co./skybase/postgres-meta) és una API RESTful per a gestionar Postgres, permet obtenir informació de taules, agregar rols, executar consultes, etc.
...
- **`supabase-{lang}`**: Combina llibreries i afegeix millores.
  ...
  - `realtime-{lang}`: Llibreria de client per a treballar amb [Realtime](https://github.co./skybase/realtime)
